...
Agnes:
Steven:
1. Researched how to use datetime-local
2. Added dates and times to all functions
3. Fixed small bug in update function where it only update the first reminder
Shaniah:
